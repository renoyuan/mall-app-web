    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="vip-card-box">
				...
				<view class="b-btn">
					{{userInfo.vipLeve || '立即开通'}}
				</view>
				<view class="tit">
					<text class="icon-iLinkapp- yticon" :style="{ color: userLevelColor  }">{{this.userLevel || '一般会员'}}</text>
				</view>
				<text class="e-m" style="color:red">mall移动端商城</text>
				<text class="e-b" style="color:red">黄金及以上会员可享有会员价优惠商品。</text>
			</view>
		</view>
		...
		>
			...
			<view class="order-section">
				...
				<view class="order-item" @click="navTo('售后')" hover-class="common-hover"  :hover-stay-time="50">
...
<script>  
    ...
    export default {
        ...
        computed: {
			...
			userLevelColor() {
			            // 根据用户等级返回对应的颜色
			            return this.colorMap[this.userLevel];
			        }
		},
        methods: {
