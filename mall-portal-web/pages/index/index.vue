<template>
	<view class="container">
		...
		<view class="cate-section">
			...
			<view class="cate-item">
				<image src="/static/temp/c6.png" @click="navToNewProudctListPage"></image>
				<text>优选</text>
			</view>
			<view class="cate-item">
...
<script>
	...
	import
	uniLoadMore
	from '@/components/uni-load-more/uni-load-more.vue';
	...
	export default {
		...
		methods: {
			...
			swiperChange(e) {
				...
				console.log("this.swiperCurren", this.swiperCurren);
